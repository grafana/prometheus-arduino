...
TimeSeries ts1(5, (char*)"uptime_milliseconds_total", (char*)"{job=\"esp32-test\",host=\"esp32\"}");

// Define a TimeSeries which can hold up to 5 samples, has a name of `heap_free_bytes`
TimeSeries ts2(5, (char*)"heap_free_bytes", (char*)"{job=\"esp32-test\",host=\"esp32\",foo=\"bar\"}");
